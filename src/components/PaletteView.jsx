...
export function PaletteView({entries,cafes,weights,updateWeight,resetWeights,totalW,weightError,cafeWeights,updateCafeW,resetCafeWeights,cafeTotalW,cafeWErr}) {

...
export function CafeGroupRow({ group, cafeSortBy, onEdit, onMove, onDelete, user, weights, showAuthor = false, dinedWithForEntry, viewerProfile, rank }) {
  const { t } = useLang();
  ...
  return (
    <>
      ...
      <EntryCard
        ...
        onMove={onMove ? () => onMove(group[group.length - 1].id) : undefined}

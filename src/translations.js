export const T = {
  en: {
    ...
    communityHintCompare:"How your taste lines up, cuisine by cuisine.",
    ...
    topPicks:"Top picks",
    compatibility:"Compatibility",sharedCuisines:"Shared cuisines",
    notEnoughSharedData:"Not enough shared cuisines yet — both of you need to rate at least 2 of the same cuisines.",
    youAgreeOn:"Where you agree",
    youShouldTry:"You should try",theyShouldTry:"They might try",
    pickFriendToCompare:"Pick a friend to compare with.",
    visitsCount:"visits",
  ...
  zh: {
    ...
    communityHintCompare:"逐一比較你跟朋友的口味。",
    ...
    topPicks:"口袋名單",
    compatibility:"契合度",sharedCuisines:"共同料理",
    notEnoughSharedData:"共同料理太少 — 你們需要至少同樣評分過 2 種料理。",
    youAgreeOn:"你們最一致",
    youShouldTry:"你可以試試",theyShouldTry:"他們可以試試",
    pickFriendToCompare:"選一位朋友開始比較。",
    visitsCount:"次造訪",
    avgTasteLabel:"平均口味",
    topReviewers:"高分評論者",
